...
<!DOCTYPE html>
	...
	<head>
		...
		<body>	  
			...
			<!-- End banner Area -->	
			<?php
				$sqlGetEvent = "select * from donner where user_id=$user_id";
										...
										if(mysqli_num_rows($event_detail) > 0 )
										{
											...
											while($event = mysqli_fetch_assoc($event_detail))
											{
												...
												if ($opening_date > $current_date)
												{
													...
													$upcomingAmount[] = $row['donated_amount'];
												}
												else
												{
												...
												<div class="col-lg-6 pb-30">
													<div class="single-carusel row align-items-center">
														...
														<div class="detials col-12 col-md-6">
															...
															<h5><?php echo $upcomingAmount[$x];?></h5>
															<p>
												...
												<div class="col-lg-6 pb-30">
													<div class="single-carusel row align-items-center">
														...
														<div class="detials col-12 col-md-6">
															...
															<h5>Donated amount: $<?php echo $pastAmount[$x];?></h5>
															<p style="width: 250px">																
																For most of us, the idea of astronomy is something we directly connect to “stargazing”, telescopes and seeing magnificent displays in the heavens.
															</p>
														</div>
				...
				else
				{
					...
					<?php
					echo "<h2>You have not donated in any event so for.</h2>";
